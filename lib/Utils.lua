...
function U.CirclesCollide(c1, c2, ratio)
    ratio = ratio or 1
    -- local d = sqrt( pow (c1.x - c2.x, 2 ) + pow( c1.y - c2.y, 2))
    -- return d < c1.cr + c2.cr
...
--exclusive or function where a and b arqqqqqqqqqqqqqqqqqqwwwwwwwwwwaaaaaaaaaaaaaaaaaassssssse booleans
--
function U.xor(a,b)
    return a ~= b
end
