...
function S.Collide(poly1, poly2)
    ...
    assert(min_pentration_axis ~=nil) -- this line caused a crash, not sure why message here:
--     Error: lib/Sat.lua:95: assertion failed!
-- stack traceback:
-- 	[string "boot.lua"]:777: in function <[string "boot.lua"]:773>
-- 	[C]: in function 'assert'
-- 	lib/Sat.lua:95: in function 'Collide'
-- 	scenes/Test.lua:230: in function 'kill_missles_with_bullets' 
-- 	scenes/Test.lua:374: in function 'update'
-- 	lib/SceneMgr.lua:91: in function 'update'
